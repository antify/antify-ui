...
const meta: Meta<typeof AntPopover> = {
    title: 'Components/Elements/Ant Popover',
...
export const Docs: Story = {
    render: (args) => ({
        ...
        template: '<div class="p-64 flex justify-center items-center"><AntPopover popover-classes="w-64" v-bind="args"><template #content>{{dummyText}}</template><template #default><AntButton @click="() => showPopover = !showPopover" outlined>Click me</AntButton></template></AntPopover></div>',
    }),
    args: {
        showPopover: true,
        title: 'Title'
